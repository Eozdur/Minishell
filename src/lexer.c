...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/26 10:46:18 by eozdur            #+#    #+#             */
/*   Updated: 2023/11/26 10:46:20 by eozdur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	lexer(t_shell *main_shell)
{
	...
	i = 0;
	str = ft_mini_split(main_shell->cmd);
	if (!str)
		return ;
	...
	while (str[i])
	{
		...
		ft_lstadd_back(&main_shell->lex_list->lex, new_node);
		i++;
	}
	free(str);
}
