...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/26 10:44:55 by eozdur            #+#    #+#             */
/*   Updated: 2023/11/26 10:44:57 by eozdur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	_create_dup(t_shell *main_shell)
{
	...
	pipe(new_fd);
	write(new_fd[1], main_shell->heredoc,
		ft_strlen(main_shell->heredoc));
	dup2(new_fd[0], 0);
	close (new_fd[1]);
	close(new_fd[0]);
}
